...
class Aplicacion():
    def __init__(self):
        ...
        tren = PhotoImage(file='/home/bladimir/Escritorio/python/tkinter/imagenes/tren-128x64.png')
        ...
        self.clase2 = ttk.Radiobutton(self.raiz, text='Primera', variable=self.clase, value='p')
        
        self.clase3 = ttk.Radiobutton(self.raiz, text='Lujo', variable=self.clase, value='l')
