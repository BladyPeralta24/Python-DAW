#Crea una función en python, que reciba como parámetro una fecha en formato AAAAMMDD y devuelva la fecha en formato 
#DD de [MM] de AAAA donde [MM] será una representación no numérica del mes.
#
#Ejemplo de uso:
#print(editar_fecha("20221001"))
#01 de Octubre de 2022

#Si no se inserta fecha, deberá contemplar la fecha actual
...
print("La hora es {} del año {}" % (hora,anho))
